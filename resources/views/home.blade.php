        ...
        <div class="collections-grid">
            ...
            <div class="collection-card">
                @if($collection->image_path)
                    <img src="{{ asset('images/' . $collection->image_path) }}" class="collection-image" alt="{{ $collection->title }}">
                @else
        ...
        <div class="products-grid">
            ...
            <div class="product-card">
                @if($product->main_image)
                    <img src="{{ $product->main_image->url }}" class="product-image" alt="{{ $product->title }}">
                @else
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="about-image">
                    <img src="https://picsum.photos/500/400?random=999"
                         alt="Jesica Riad Studio"
                         class="img-fluid">
                </div>
            </div>
        </div>
