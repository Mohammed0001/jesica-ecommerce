                ...
                <div class="col-lg-8 mx-auto">
                    <div class="story-content">
                        ...
                        <div class="story-text">
                            ...
                            <p>
                                What started as a personal passion for creating unique pieces has evolved into a dedicated
                                craft that blends traditional techniques with contemporary design sensibilities. Each piece
                                I create is born from careful consideration of form, function, and the story it will tell
                                in its new home.
                            </p>
                            <p>
                                My work draws inspiration from the intersection of minimalist aesthetics and organic forms,
                                creating pieces that are both timeless and distinctly modern. Every creation is meticulously
                                handcrafted in my studio, where attention to detail and quality craftsmanship are paramount.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="philosophy-image">
                        <img src="{{ asset('images/philosophy.jpg') }}" alt="Craftsmanship philosophy" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="philosophy-points">
                            <div class="philosophy-point">
                                ...
                                <div class="point-content">
                                    ...
                                    <p>Every piece is crafted with genuine love and dedication, ensuring that the passion
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="process-step">
                        ...
                        <p class="step-description">
                            Drawing inspiration from nature, architecture, and everyday moments to conceptualize unique designs.
                        </p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                ...
                <div class="col-lg-10 col-xl-8 mx-auto">
                    <div class="values-content">
                        ...
                        <div class="value-block">
                            ...
                            <p class="value-description">Creating genuine, one-of-a-kind pieces that reflect true artisanal craftsmanship</p>
                        </div>

                        <div class="value-block">
                            <h3 class="value-heading">Innovation</h3>
                            <p class="value-description">Constantly exploring new techniques while respecting traditional methods</p>
                        </div>

                        <div class="value-block">
                            <h3 class="value-heading">Connection</h3>
                            <p class="value-description">Building meaningful relationships with clients through shared appreciation for handmade beauty</p>
                        </div>

                        <div class="value-block">
                            <h3 class="value-heading">Excellence</h3>
                            <p class="value-description">Maintaining the highest standards in every aspect of creation and service</p>
                        </div>

                        <div class="cta-block">
                            <h3 class="cta-heading">Let's Create Something Beautiful Together</h3>
                            <p class="cta-text">Whether you're looking for a unique piece from my existing collection or interested in commissioning a custom creation, I'd love to hear from you.</p>
